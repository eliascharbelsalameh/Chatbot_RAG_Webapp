...
# Define directories relative to the repo root (one level above legacy/).
REPO_ROOT = os.path.abspath(os.path.join(CURRENT_DIR, os.pardir))
VECTORSTORE_DIR = os.path.join(REPO_ROOT, 'vectorstore', 'db_faiss')
INPUT_DIRECTORY = os.path.join(REPO_ROOT, 'data', 'docs')
